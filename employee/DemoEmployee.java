...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		// TODO To complete
		// emp3.whoAmI() 
		// prints "PART TIME EMPLOYEE" because emp3 is equal to pEmp1 and pEmp1 is a part time employee.
		
		// emp3.getHourlyRate(); // returns syntax error because the method "getHourlyRate()" is only defined in PartTimeEmployee
		// and emp3 is an extension so getHourlyRate is lost when transitioned from employee to part time employee
		...
		// because the type that we are trying to downcast to does not match that of the 
		// object that we are downcasting.
